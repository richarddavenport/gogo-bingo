[ ] - add a landing page with instructions and new game button, and join game with code option
[ ] - add another start game button below gametypes, leave the current one
